      ...
      subsections: [
        {
          ...
          content: "These cookies are necessary for the operation of our Site and to enable the basic functions of the website, such as logging in to your account or completing transactions. Without these cookies, services you have requested, such as customer sign-ups, cannot be provided.\n\nExamples: Authentication cookies to remember your login session, or cookies that store your preferences while filling out the KYC form."
        },
        {
          subtitle: "2.2. Performance Cookies",
          content: "These cookies collect information about how visitors use our Site. For example, they help us understand how users navigate between pages, which pages they visit the most, and if they receive error messages from certain pages. These cookies do not collect personal data that could identify you. All information these cookies collect is aggregated and therefore anonymous.\n\nExamples: Google Analytics, Mixpanel, and similar tools."
        },
        {
          subtitle: "2.3. Functionality Cookies",
          content: "Functionality cookies allow the Site to remember your preferences and choices (such as language selection or region) and provide enhanced, personalized features. These cookies enable us to customize your experience on our Site, providing features such as remembering your progress through the KYC form or your previous interactions with our embedded eBay store.\n\nExamples: Language or currency preferences, personalization features."
        },
        {
          subtitle: "2.4. Targeting or Advertising Cookies",
          content: "These cookies are used to deliver content that is more relevant to you and your interests. They are also used to limit the number of times you see an advertisement and help measure the effectiveness of advertising campaigns. These cookies may be set by third-party advertisers or social media platforms when you interact with their content.\n\nExamples: Cookies from advertising networks or social media platforms such as Facebook, Twitter, LinkedIn, or Google Ads."
        },
        {
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="mb-8 sm:mb-10 md:mb-12 lg:mb-16">
          <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
            This Cookie Policy explains how <span className="font-semibold text-cyan-400">BitWisdom Ai Network</span> ("we," "our," or "us") uses cookies and similar technologies on our website ("Site"). By using our Site, including signing up, submitting customer information, filling out KYC forms, reviewing the Licensing Agreement, or interacting with any other feature, you consent to the use of cookies as described in this policy.
          </p>
        ...
        >
          ...
          <p className="text-gray-300 text-xs sm:text-sm md:text-base leading-relaxed">
            By continuing to use the BitWisdom Ai Network website, you acknowledge that you have read and understood this Cookie Policy and consent to our use of cookies as described. You may manage your cookie preferences at any time through your browser settings.
          </p>
        </div>
      </div>
